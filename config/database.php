...
return [
    ...
    */
    ...
    'connections' => [
        ...
        // One-off connection to the imported legacy CakePHP database (db/00-structure.sql +
        // db/02-data-prod.sql), used only by the LegacyContentSeeder to migrate real content.
        'legacy' => [
            'driver' => 'mysql',
            'host' => env('DB_HOST', '127.0.0.1'),
            'port' => env('DB_PORT', '3306'),
            'database' => 'cessa_legacy',
            'username' => env('DB_USERNAME', 'root'),
            'password' => env('DB_PASSWORD', ''),
            'charset' => 'utf8mb4',
