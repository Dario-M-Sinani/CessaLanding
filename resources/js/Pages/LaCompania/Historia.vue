    ...
    <div class="py-16 bg-white min-h-screen">
      <div class="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 space-y-12">
        <div class="text-center space-y-4">
          ...
          <h1 class="text-4xl sm:text-5xl font-extrabold text-blue-950 tracking-tight">Historia de CESSA</h1>
          <p class="text-gray-600 text-base max-w-2xl mx-auto">
            Décadas impulsando el crecimiento y la electrificación de Chuquisaca.
          </p>
        </div>
