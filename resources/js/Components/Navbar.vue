        ...
        <div class="relative group" @mouseenter="openDropdown = 'servicios'" @mouseleave="openDropdown = null">
          ...
          >
            <div class="bg-white border border-gray-200 rounded-xl p-2 space-y-1 shadow-2xl">
              ...
              <Link href="/actualizar-datos" class="block px-3.5 py-2 rounded-lg text-xs font-medium text-gray-700 hover:text-blue-900 hover:bg-blue-50 border-l-2 border-transparent hover:border-amber-500 transition-all">
